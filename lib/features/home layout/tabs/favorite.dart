...
class _FavoriteTabState extends State<FavoriteTab>
  ...
  int curruntIndex = 0;
  final List<Widget> pages = [FollowingTab(), const YouTab()];
  @override
  void initState() {
    super.initState();
      ...
      body: SafeArea(
        child: Column(
          children: [
            DefaultTabController(
              ...
              child: SizedBox(
                ...
                child: TabBar(
                  ...
                  tabs: ls
                      .map(
                        (e) => Tab(height: 30, child: Center(child: Text(e))),
                      )
                      .toList(),
                ),
              ),
            ...
            Expanded(
              child: PageView(
                // A PageView needs to be in an Expanded widget or a container with a fixed height when inside a Column.
